    ...
    <div data-testid="admin-settings"><h1 className="text-3xl font-black tracking-tight mb-8">Settings</h1>
      ...
      <div className="border border-white/10 bg-[#141414] p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2"><label className="block text-sm text-white/60 mb-2">Sender Email Address</label><input data-testid="settings-sender-email" value={settings.sender_email} onChange={e => setSettings(s => ({ ...s, sender_email: e.target.value }))} placeholder="noreply@skylinemedia.ca" className="w-full bg-white/5 border border-white/10 px-4 py-3 text-sm focus:border-[#d4af37] focus:outline-none placeholder:text-white/20" /></div>
        </div>
